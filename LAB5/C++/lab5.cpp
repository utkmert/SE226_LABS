...
string passGen(string words[], int number){
    string password ="";
...
int main() {
    ...
    int user_number;
    cout<<"Please enter a number between 3-7 : ";
    cin>>user_number;

    while (user_number<3 || user_number>7){
        cout<< "It has to be between 3 and 7 ";
        cin>>user_number;
    }

    string initialpassword = passGen(words, user_number);
    cout<<"Initial password: "<<initialpassword;

    string newpassword = rep_with_upper(initialpassword);
    cout<<"\nNew password: "<<newpassword;

    string finalpassword = swap_letters(newpassword);
    ...
    if (search_letter(finalpassword,first_letter)){
        cout<< "Your key in the password.";
    }else{
        cout<<"Your key not in the password.";
    }
    return 0;
}
